...
function PromiseModal({ isOpen, onClose }) {
    ...
    return (
        ...
        >
            ...
            <div
                className="bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 rounded-3xl p-6 md:p-12 max-w-3xl w-full relative overflow-hidden shadow-2xl max-h-[90vh] overflow-y-auto"
